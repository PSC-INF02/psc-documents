...
\begin{itemize}
  \item Ou bien introduire un facteur de désactivation des n\oe{}uds au cours du temps, permettant éventuellement d'arriver à un état d'équilibre~;%% RQ : L'activation s'assimilant à un procédé de chaîne de Markov, la limite est indépendante de l'entrée
...
Selon une lemme de Hans \textsc{Peter Luhn}, le poids d'un terme est proportionnel à sa fréquence d'apparition.
