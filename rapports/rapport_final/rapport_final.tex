...
Le logarithme permet de faire tendre l'indice IDF d'un terme vers 0 lorsque le nombre d'occurences du terme dans le corpus augmente. En particulier, les mots qui sont présents dans tous les documents seront filtrés car ils ont un indice nul.
