...
Nous avons, d'autre part, pu implémenter un algorithme raisonnable de résumé automatique s'appuyant sur TF-IDF. Les résultats produits (voir un exemple en annexe B) sont raisonnables, bien qu'un peu flous.

Pour ce qui est de l'organisation du temps et des ressources, les réunions régulières nous ont permis de rester en synergie et de ne garder des modules indépendants mais compatibles pendant la majeure partie du développement.
